...
**Analyzed:** 2026-05-02T01:40:32.783818+00:00
...
Explicit Valkey support detected. 6 related issue(s)/PR(s) found. 5 related extension repo(s) found (0 mention Valkey). Redis modules used: redistimeseries.
...
- `redistimeseries` / `ts.add`: 388 file(s)
